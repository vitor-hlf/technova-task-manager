...
1. Clone este repositório para a sua máquina local: `git clone https://github.com/vitor-hlf/technova-task-manager.git`
2. Acesse o diretório do projeto: `cd technova-task-manager`
3. Execute o script principal via terminal: `uvicorn main:app --reload`
...
1. Atualize sua branch local de integração: `git checkout develop` e `git pull`.
2. Crie uma branch para sua nova funcionalidade: `git checkout -b feature/nome-da-sua-feature`.
3. Desenvolva o código e faça commits padronizados.
4. Envie a branch para o repositório remoto: `git push -u origin feature/nome-da-sua-feature`.
5. Abra um Pull Request (PR) da sua branch para a `develop`.
6. Após a revisão e aprovação, faça o merge do PR.
...
A organização dos diretórios e arquivos segue a estrutura abaixo:
* `/main.py` # Script principal simulando as operações de CRUD da API
